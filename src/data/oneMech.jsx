const oneMech =
{
    ...
    compname: 'abc Garage',
    distance: 1.8,
    vehicleType: 'Swift Dzire sedan car model India',
    img: require('../images/download5.jpg'),
    rating: 4.2,
    ...
    location: 'Delhi',
    phoneNum: '+917972755589',
    experience: '4.5 years',
    email: 'company@gmail.com',
    address: 'Road name ,near xyz ,east wing ,New Delhi-431206',
    mincharge: 400,
}

export default oneMech;